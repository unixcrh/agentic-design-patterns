...
7. [多 Agent 协作](Chapter%207_%20Multi-Agent%20Collaboration.md)（17页）
...
## 第四部分：高级架构（114页）
15. [Agent 间通信(A2A)](Chapter%2015_%20Inter-Agent%20Communication%20(A2A).md)（15页）
...
23. [AI Agent 交互：从GUI到真实世界](Appendix%20B%20-%20AI%20Agentic%20Interactions_%20From%20GUI%20to%20Real%20world%20environment.md)（6页）
24. [Agent 框架概览](Appendix%20C%20-%20Quick%20overview%20of%20Agentic%20Frameworks.md)（8页）
25. [使用AgentSpace构建 Agent](Appendix%20D%20-%20Building%20an%20Agent%20with%20AgentSpace%20(on-line%20only).md)（6页）
26. [命令行AI Agent](Appendix%20E%20-%20AI%20Agents%20on%20the%20CLI.md)（5页）
